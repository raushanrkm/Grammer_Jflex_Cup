...
/*{IDENTIFIER} { return sf.newSymbol("IDENTIFIER",sym.IDENTIFIER); }*/


{WhiteSpace} { /* ignore white space. */ }
. { System.err.println("Illegal syantax [Error:] "+ "' " + yytext()+ " ' "+"  line number = " + yyline + " column number = " + yycolumn); } /* catches anything else */